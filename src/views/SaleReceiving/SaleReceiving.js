...
import * as saleReceivingAction from '../../redux/actions/saleReceiving';
...
class SaleReceiving extends Component {
    ...
    static navigationOptions = ({ navigation }) => {
        return {
            headerTitle: <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 22 }}>Sale And Receiving</Text>,
            headerStyle: {
    ...
    renderListItems = () => {
        ...
        return menu.saleReceiving.map((e, i) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(SaleReceiving);