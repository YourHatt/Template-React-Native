...
import * as weightManagementAction from '../../redux/actions/weightManagement';
...
class WeightManagement extends Component {
    ...
    renderListItems = () => {
        ...
        return menu.weightManagement.map((e, i) => {
...
WeightManagement.navigationOptions = () => ({
...
const mapDispatchToProps = dispatch => {
    return bindActionCreators(
        {
            ...weightManagementAction,
        }, dispatch
    )
}

export default connect(mapStateToProps, mapDispatchToProps)(WeightManagement);