...
import * as plantationAction from '../../redux/actions/plantation';
...
class Plantation extends Component {
    ...
    static navigationOptions = ({ navigation }) => {
        return {
            headerTitle: <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 22 }}>Plantation</Text>,
            headerStyle: {
    ...
    renderListItems = () => {
        ...
        return menu.plantation.map((e, i) => {
